  ...
  return (
    <input
      ...
      className={cn(
        ...
        'focus-visible:border-primary focus-visible:shadow-[0_0_8px_[var(--main-third)]] placeholder:opacity-100 focus:placeholder:opacity-0 placeholder:transition-opacity placeholder:duration-300',
